      ...
      <section className="py-20 bg-marina-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-marina-sand rounded-2xl p-10 flex items-center justify-center min-h-[350px]">
              <div className="text-center text-marina-slate/40">
                <Users size={80} className="mx-auto mb-4 text-marina-teal/30" />
                <p className="text-sm">Marina team photo</p>
              </div>
            </div>
          </div>
        </div>
